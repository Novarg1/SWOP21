...
//		assertEquals(workstation3.toString(),"company.workstations.CargoPost");
	...
	public void getWorkTimeTest2(){
		...
		task.perform(workstation1, 3);
		assertEquals(3,workstation1.getWorktime());
	}
	
	@Test
	public void getPendingTasksTest_NoTasks(){
		Set<Task> pendingTasks = workstation2.getPendingTasks();
		assertFalse(pendingTasks.size() > 0);
