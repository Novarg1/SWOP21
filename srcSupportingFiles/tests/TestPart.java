...
public class TestPart {
	...
	public void testAirco(){
		...
		assertEquals(AccessoiresPost.class,aircoAuto.getResponsibleWorkstation());
	...
	public void testPartInterface(){
		...
		assertEquals(AccessoiresPost.class, partAirco.getResponsibleWorkstation());
		...
		assertEquals(AccessoiresPost.class, partSeats.getResponsibleWorkstation());
		assertEquals(AccessoiresPost.class, partWheels.getResponsibleWorkstation());
		assertEquals(AccessoiresPost.class, partSpoiler.getResponsibleWorkstation());
	}
}
