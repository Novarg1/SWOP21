...
import car.PimpMobileSpecification;
...
public class OrderProcessController implements FunctionalityController
{
	...
	public boolean provideFunctionality(UserInterface userInterface) 
	{
		...
		try 
		{
			CarModelSpecification spec = new PimpMobileSpecification(body, color, engine, gearbox, seats, airco, wheels);
